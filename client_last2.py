...
def record_audio(filename="//home//elniko//Samsam_Flask//user_audio.wav"):
...
def send_audio_to_server(filename):
    ...
    if response.status_code == 200:
        ...
        initial_path = "//home//elniko//Samsam_Flask//"
...
def main():
	...
	play_audio_file_non_blocking('//home//elniko//Samsam_Flask//start_2.wav')
	time.sleep(2)
	while True:
		...
		record_audio(filename="//home//elniko//Samsam_Flask//user_audio.wav")
		# Send the audio file to the server and stream the response audio
		send_audio_to_server("//home//elniko//Samsam_Flask//user_audio.wav")
